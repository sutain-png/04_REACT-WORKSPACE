...
/*
  1. React.useReducer()
    ...
    3) 주요 특징
      ...
      (3) Redux와 유사한 패턴
        ▶︎ dispatch를 통해 액션을 전달하고, reducer 함수에서 액션 타입에 따라 상태를 업데이트합니다. 
          이 패턴은 Redux와 비슷해, 전역 상태 관리에도 확장하기 쉽습니다.
  ...
  2. React.useReducer() 구문
    ...
    2) 설명
      ...
      (2) dispatch
        ...
        - 액션을 인자로 가지며 반환은 없습니다. 즉, dispatch === (action) => {}
